...
const Index = () => {
  ...
  useEffect(() => {
    const loadDefaultProducts = async () => {
      setIsLoading(true);
      try {
        const defaultBarcodes = ["7315360061503", "7350035210169", "7340083447532", "7622201727840", "7318690140412", "7310070005441", "6410500090014", "7318690140412", "7310130006067", "4016241050304", "7318690146261", "7350028546411"];
